...
/**
 * Class to handle communication with webservice for data collection using XMLRPC
 *
 * @author Dean Kramer <d.kramer@mdx.ac.uk>
 */
public class XmlRpcUploader implements DataUploader {
    ...
    private static final String LOG_TAG = "XmlRpcUploader";
    private DataCollector mCollector;
    private ConnectivityManager mConnectivityManager;
    private Context mContext;

    public XmlRpcUploader(Context context, DataCollector collector) {
        mContext = context;
